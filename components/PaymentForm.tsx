...
//       <div className="space-y-2">
//         <label className="block text-sm font-medium text-zinc-200">Amount (ETH)</label>
//         <div className="relative">
//           <input
//             type="number"
//             name="amount"
...
//       {success && (
//         <div className="bg-green-500/10 border border-green-500/50 text-green-700 p-4 rounded-lg flex items-center space-x-2">
//           <span>✓</span>
...
//           <label className="block text-sm font-medium text-zinc-200">Payment Interval</label>
//           <button
//             type="button"
